...
import com.jiahuiling.xiaojiashu.gateway.constant.RedisKeyConstants;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getRoleList(Object loginId, String loginType) {
        ...
        // 构建 用户-角色 Redis Key
        String userRolesKey = RedisKeyConstants.buildUserRoleKey((Long) loginId);

        // 根据用户 ID ，从 Redis 中获取该用户的角色集合
        String userRolesValue = (String) redisTemplate.opsForValue().get(userRolesKey);
