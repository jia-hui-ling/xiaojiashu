...
-- =====================================================================
-- Nacos 容器连接 MySQL 使用的账号（对应 nacos 容器环境变量
-- MYSQL_SERVICE_USER=nacos / MYSQL_SERVICE_PASSWORD=nacos）
-- =====================================================================
...
INSERT INTO `config_info` VALUES (1,'xiaojiashu-oss-dev.yaml','DEFAULT_GROUP','storage:\r\n  type: minio # 对象存储类型','02d19083eda28433fa9104448e34999a','2026-09-05 19:21:17','2026-09-05 19:21:17',NULL,'172.17.0.1','','xiaojiashu',NULL,NULL,NULL,'yaml',NULL,'');
...
INSERT INTO `his_config_info` VALUES (0,1,'xiaojiashu-oss-dev.yaml','DEFAULT_GROUP','','storage:\r\n  type: minio # 对象存储类型','02d19083eda28433fa9104448e34999a','2026-09-05 19:21:16','2026-09-05 19:21:17',NULL,'172.17.0.1','I','xiaojiashu','');
...
INSERT INTO `tenant_info` VALUES (1,'1','xiaojiashu','xiaojiashu','小贾书：仿小红书项目（基于spring Cloud Alibaba 微服务框架）','nacos',1788582417988,1788582417988);
